...
def game():
    ...
    choice = input("Do You Want to Hit or Stay?").capitalize() # İf your Hand is like ['A'and any of these cards[Q,K,J,10]] It doesnt automatically understands that you have blackjack so you have to stay.Sorry too lazy to do it
    while not choice in ["H", "S", "Stay", "Hit"]:
        print("You Have to Enter Your Move!")
        choice = input("Do You Want to Hit or Stay? İf You Want to Quit Enter 'Q': ").capitalize()
        if choice == "Q":
    ...
    while choice in ["H", "Hit"]:
        ...
        if user_point == 21:
            ...
            wait(0.5)
            print(f"Dealer Reveals the Hidden Card... It's {hidden_card}\nDealer's Hand = {dealer_hand}")
            ...
            if dealer_point > user_point:
                print("Dealer Wins! My Advice, You Really Should Check This Website https://quickabdest.com")
                quit()
            elif dealer_point == user_point:
                print("Draw! My Advice, You Really Should Check This Website https://quickabdest.com")
